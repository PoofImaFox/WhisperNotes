...
internal static class ConfigCommand
{
    ...
    [
        ...
        new("Diarization.ProfileMatchThreshold",
            static s => Number(s.Diarization.ProfileMatchThreshold),
            static (s, v) => s.Diarization.ProfileMatchThreshold = CosineDistance(v.Key, v.Trimmed)),
